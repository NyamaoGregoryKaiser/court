     ...
     <!-- Navigation -->
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">CMS registration</a>
            </div>
            <!-- /.navbar-header -->
            <ul class="nav navbar-nav navbar-right">
			    ...
			    <li class="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="m_2"><a href="#"><i class="fa fa-user"></i> Nyamao Gregory kaiser <span class="label label-info"></span></a></li>
						<li class="m_2"><a href="#"><i class="fa fa-envelope-o"></i> registrar@greg.co.ke<span class="label label-success"></span></a></li>
